...
**Status:** mathematical identities rechecked; post-hoc mechanism probes
completed; implementation authorized  
**Date:** 2026-07-22  
...
- accept only weights that do not increase either quantity relative to the
  pre-step particles, up to an explicit tolerance; and
