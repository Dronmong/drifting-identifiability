...
The next P1 checkpoint is a development screen of active 32 and 64 on the
20-step profile, together with the full-bank comparator.  Active 16 should be
retained as the aggressive boundary, not assumed to be the likely winner.
Local-field scheduling, coreset approximation, and positive-feature
approximation remain unimplemented.
