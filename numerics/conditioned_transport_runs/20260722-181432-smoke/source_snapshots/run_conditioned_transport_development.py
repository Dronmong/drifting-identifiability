...
def train_arm(
    ...
    *,
    ...
    projection_products += PARTICLE_POPULATION * scheduled_direction_total
    sort_work = (
    ...
    if protect:
        ...
        projection_products += 6 * PARTICLE_POPULATION * scheduled_direction_total
        sort_work += (
            scheduled_direction_total
            * PARTICLE_POPULATION
            * math.log2(PARTICLE_POPULATION)
...
def main() -> None:
    ...
    artifact.log(
        ...
        + ("full registered atlas" if args.active_directions == 0 else str(args.active_directions))
    )
