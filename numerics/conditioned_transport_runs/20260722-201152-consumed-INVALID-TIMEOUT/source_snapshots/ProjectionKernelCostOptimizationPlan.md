...
The next step is a fresh paired confirmation of frozen active-32 plus `M=128`,
with dense active-32, `M=64`, and the paper port as comparators.  Positive
feature approximation (K3) remains unimplemented and should not be selected
on the consumed development registry before that confirmation.
