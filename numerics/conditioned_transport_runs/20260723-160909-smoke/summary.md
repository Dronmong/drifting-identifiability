...
Conditioned transport audit runner: 4 targets x 4 arms
  ...
  NPR-d8-correlated-t: L=64, kappa=8.81, 0.46s
  NPR-d16-nonlinear: L=192, kappa=19.10, 0.68s
  cta-exact-fixed-control  ED2=0.067944 SW1=0.176608 train=0.035s setup+train=0.046s coverage>=0.500 local=0.250
  cta-exact-gated-hybrid   ED2=0.066748 SW1=0.177862 train=0.046s setup+train=0.054s coverage>=0.500 local=0.250
  cta-exact-rollout2       ED2=0.056614 SW1=0.173287 train=0.047s setup+train=0.055s coverage>=0.500 local=0.250
  cta-exact-rollout4-safe-balanced ED2=0.069146 SW1=0.188862 train=0.065s setup+train=0.075s coverage>=0.500 local=0.070
```
