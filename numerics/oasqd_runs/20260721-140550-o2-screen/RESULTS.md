...
- best OA candidate: `oa-stop-full-H25-P25-N2048-K8`
...
```json
{
  ...
  "work_totals": {
    "fixed-lbqcd": {
      "wall_seconds": 70.86147770017851,
    ...
    "oa-pulse-full-H25-P25-N2048-K8": {
      "wall_seconds": 49.82858990007662,
      "generator_example_evals": 14787456.0,
      "backward_example_evals": 8270720.0,
      "kernel_pairs": 377487360.0,
      "total_new_target_samples": 9057152.0,
      "global_updates": 3745.0,
      "divergences": 0.0
    },
    "oa-stop-full-H25-P25-N2048-K8": {
      "wall_seconds": 67.58919980021892,
    ...
    "paper-0.5": {
      "wall_seconds": 58.29003000003286,
    ...
    "qld-v1": {
      "wall_seconds": 29.208917000243673,
