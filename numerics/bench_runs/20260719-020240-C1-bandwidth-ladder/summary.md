...
target: K Gaussians, sep L, width 0.15L; N=20K particles, batch=64, 800 steps, eta=0.1*tau_fine
  --- K=4 d=1 L=5.0: single-best tau=1.500 (sigma=0.750) ---
    ...
    ladder-eq   : ED=0.0572 cover=1.00 massErr=0.200 steps->tol=20
    anneal      : ED=0.0055 cover=1.00 massErr=0.013 steps->tol=10
  ...
  --- K=4 d=2 L=5.0: single-best tau=1.500 (sigma=0.750) ---
    ...
    ladder-eq   : ED=0.1968 cover=1.00 massErr=0.287 steps->tol=5039
    anneal      : ED=0.0306 cover=1.00 massErr=0.063 steps->tol=20
  ...
  --- K=8 d=2 L=5.0: single-best tau=1.500 (sigma=0.750) ---
    ...
    ladder-eq   : ED=0.0459 cover=1.00 massErr=0.312 steps->tol=50
    anneal      : ED=0.0154 cover=1.00 massErr=0.044 steps->tol=20
  ...
  --- K=4 d=5 L=5.0: single-best tau=5.000 (sigma=0.750) ---
    ...
    ladder-eq   : ED=0.0782 cover=1.00 massErr=0.125 steps->tol=60
    anneal      : ED=0.0686 cover=1.00 massErr=0.050 steps->tol=20
