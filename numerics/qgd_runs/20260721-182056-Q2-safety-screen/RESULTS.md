...
The run produced 192 arm-level rows in 167.0 seconds. All ratios below use the same-run LB-QCD arm as 1.0 and aggregate target/initialization cells by the geometric mean of paired cell-median ratios.
...
| qsafe-permissive | 0.9998 | 1.0000 | 1.0000 | 0.9996 | 0.9997 | 0.9999 |
...
| qsafe-balanced | 0.001 | 0.000 | 0.000 | 0.000 | 0 |
| qsafe-permissive | 0.004 | 0.000 | 0.000 | 0.000 | 0 |
